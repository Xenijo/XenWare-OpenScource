...
if game.PlaceId == 7167319176 then
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/bloodball/-back-ups-for-libs/main/wizard"))()
     ...
     --loadstring(game:HttpGet("https://raw.githubusercontent.com/Xenijo/XenWare-OpenScource/main/Silent%20Aim.lua"))()
    ...
    Player:CreateButton(
        ...
        function()
            ...
            UIS.InputBegan:connect(function(UserInput)
                    if UserInput.UserInputType == Enum.UserInputType.Keyboard and UserInput.KeyCode == Enum.KeyCode[tostring(sh)] then
                        _G.Running = true
                            while wait(0.005) and _G.Running == true do
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame + game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.lookVector * 5
            end     end
            end)
